...
import 'respiration_ansiety_model.dart';
export 'respiration_ansiety_model.dart';

class RespirationAnsietyWidget extends StatefulWidget {
  const RespirationAnsietyWidget({super.key});

  @override
  State<RespirationAnsietyWidget> createState() =>
      _RespirationAnsietyWidgetState();
}

class _RespirationAnsietyWidgetState extends State<RespirationAnsietyWidget>
    with TickerProviderStateMixin {
  late RespirationAnsietyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RespirationAnsietyModel());
