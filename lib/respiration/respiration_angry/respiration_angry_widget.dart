...
import 'respiration_angry_model.dart';
export 'respiration_angry_model.dart';

class RespirationAngryWidget extends StatefulWidget {
  const RespirationAngryWidget({super.key});

  @override
  State<RespirationAngryWidget> createState() => _RespirationAngryWidgetState();
}

class _RespirationAngryWidgetState extends State<RespirationAngryWidget>
    with TickerProviderStateMixin {
  late RespirationAngryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RespirationAngryModel());
