...
import 'respiration_sadness_model.dart';
export 'respiration_sadness_model.dart';

class RespirationSadnessWidget extends StatefulWidget {
  const RespirationSadnessWidget({super.key});

  @override
  State<RespirationSadnessWidget> createState() =>
      _RespirationSadnessWidgetState();
}

class _RespirationSadnessWidgetState extends State<RespirationSadnessWidget>
    with TickerProviderStateMixin {
  late RespirationSadnessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RespirationSadnessModel());
