...
import 'meditation_mindfulness_model.dart';
export 'meditation_mindfulness_model.dart';

class MeditationMindfulnessWidget extends StatefulWidget {
  const MeditationMindfulnessWidget({super.key});

  @override
  State<MeditationMindfulnessWidget> createState() =>
      _MeditationMindfulnessWidgetState();
}

class _MeditationMindfulnessWidgetState
    extends State<MeditationMindfulnessWidget> {
  late MeditationMindfulnessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditationMindfulnessModel());
  }
